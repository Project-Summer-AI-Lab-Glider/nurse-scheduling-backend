...
class TokenBuilder:
    def __init__(self) -> None:
        ...
        self.permissions = ''
        self.user_id = ''
        self.header = json.dumps({'typ': 'JWT', 'alg': 'HS256'}).encode('utf-8')
    ...
    def _generate_payload(self) -> None:
        self.payload = json.dumps({"userId": self.user_id, "permissions": self.permissions}).encode('utf-8')
    ...
    def generate_token(self) -> str:
        if not self.inited:
            return "PLEASE INIT THE BUILDER FIRST"
